          ...
          children: [
            ...
            Container(
              ...
              child: const Row(
                ...
                children: [
                  Text('一', style: TextStyle(color: Colors.grey, fontSize: 11)),
                  Text('二', style: TextStyle(color: Colors.grey, fontSize: 11)),
                  Text('三', style: TextStyle(color: Colors.grey, fontSize: 11)),
                  Text('四', style: TextStyle(color: Colors.grey, fontSize: 11)),
                  Text('五', style: TextStyle(color: Colors.grey, fontSize: 11)),
                  Text('六', style: TextStyle(color: Colors.lightBlue, fontSize: 11)),
                  Text('日', style: TextStyle(color: Colors.lightBlue, fontSize: 11)),
                ],
              ),
            ),
            Expanded(
                        ...
                        builder: (context, child) {
                          return GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final dailyTasks = taskData.getTasksByDate(cellDate);
                              final isToday = cellDate.year == DateTime.now().year &&
                                  cellDate.month == DateTime.now().month &&
                                  cellDate.day == DateTime.now().day;

                              return GestureDetector(
                                onTap: () => _openDayDetails(cellDate),
                                child: Container(
                                  decoration: BoxDecoration(
                                    color: Colors.white,
                                    border: Border.all(
                                      color: isToday ? Colors.lightBlue : Colors.grey.shade200,
                                    ...
                                    children: [
                                      Align(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            color: isToday ? Colors.lightBlue : Colors.transparent,
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              ...
                                              color: isToday
                                                  ? Colors.white
                                                  : (index % 7 >= 5 ? Colors.lightBlue : Colors.black54),
                                            ),
                                          ),
                                        ),
                                      ),
                                      ...
                                      Expanded(
                                        child: ClipRect(
                                          child: Column(
                                            crossAxisAlignment: CrossAxisAlignment.stretch,
                                            children: dailyTasks.take(6).map((t) {
                                              final listColor = t.isReadOnly
                                                  ? Colors.orange
                                                  : taskData.getListColor(t.listName ?? '');
